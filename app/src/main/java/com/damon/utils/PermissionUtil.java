...
public class PermissionUtil {
    public final static int REQUEST_CODE_RECORD = 1001;         // 视频录制权限
    public static final int REQUEST_CODE_LOCATION = 1002;       // 定位权限
    public static final int REQUEST_CODE_READ_WRITE = 1003;     // 读写权限
